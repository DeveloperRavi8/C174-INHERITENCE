...
label = Label(root, text="Assigning Jobs", font=("times",20,"bold"), fg="dark olive green")
...
label_IT.place(relx=0.04, rely=0.45, anchor=CENTER)
...
label_chemical.place(relx=0.04, rely=0.75, anchor=CENTER)
